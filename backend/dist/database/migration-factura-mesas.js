        ...
        `, (err) => {
                    ...
                    db.all("PRAGMA table_info(facturas)", (err, columns) => {
                        ...
                        if (mesaIdColumnExists) {
                            ...
                            db.all("SELECT id, mesa_id FROM facturas WHERE mesa_id IS NOT NULL", (err, facturas) => {
                                if (err) {
                                    reject(err);
                                    return;
                                }
...
exports.migrarFacturaMesas = migrarFacturaMesas;
// Ejecutar si se llama directamente
if (require.main === module) {
    (0, exports.migrarFacturaMesas)()
        .then(() => {
...
//# sourceMappingURL=migration-factura-mesas.js.map